 ...
 */
public class FixNavHostFragment extends Fragment implements NavHost {
     ...
     * looking first for a {@link FixNavHostFragment} along the given Fragment's parent chain.
    ...
    public static NavController findNavController(@NonNull Fragment fragment) {
        ...
        while (findFragment != null) {
            if (findFragment instanceof FixNavHostFragment) {
                return ((FixNavHostFragment) findFragment).getNavController();
            }
            ...
            if (primaryNavFragment instanceof FixNavHostFragment) {
                return ((FixNavHostFragment) primaryNavFragment).getNavController();
            }
...
//                + " does not have a NavController set");
     ...
     */
    @NonNull
    public static FixNavHostFragment create(@NavigationRes int graphResId) {
    ...
    public static FixNavHostFragment create(@NavigationRes int graphResId,
        ...
        final FixNavHostFragment result = new FixNavHostFragment();
        if (b != null) {
     ...
     * <p>
     * By default, this adds a {@link FixFragmentNavigator}.
     * <p>
...
//        dialogFragmentNavigator.onAttachFragment(childFragment);
     ...
     * {@link FixFragmentNavigator}, which replaces the entire contents of the NavHostFragment.
     * <p>
     * This is only called once in {@link #onCreate(Bundle)} and should not be called directly by
     * subclasses.
     *
    ...
    @Deprecated
    @NonNull
    protected Navigator<? extends FixFragmentNavigator.Destination> createFragmentNavigator() {
